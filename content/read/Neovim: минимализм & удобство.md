...
![Моя конфигурация](/NeovimConfig.png)
...
![Разделение экрана](/NeovimSplit.png)
...
![Замена текста](/NeovimReplace.png)
...
![Встроенный терминал](/NeovimTerminal.png)
...
Надеюсь статья была полезной. Больше статей в [моём блоге](https://t.thegblog).
